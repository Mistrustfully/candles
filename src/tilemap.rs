...
// https://github.com/Trouv/bevy_ecs_ldtk/blob/main/examples/platformer/systems.rs#L78
pub fn spawn_tile_colliders(
    mut commands: Commands,
    tile_query: Query<(&GridCoords, &Parent), Added<TileCollider>>,
    parent_query: Query<&Parent, Without<TileCollider>>,
...
impl Plugin for TilemapPlugin {
    fn build(&self, app: &mut App) {
        app.insert_resource(LevelSelection::Index(0))
            ...
            .register_ldtk_int_cell::<TileColliderBundle>(1);
    }
}
